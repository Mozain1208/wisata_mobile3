...
import 'package:aslab_travel/project/widgets/rekomedasi_destination.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<TravelDestination> rekomedasi = listDestination
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  'Destinasi Populer Tempat Wisata',
                  style: TextStyle(
                    fontSize: 16,
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                DetailDestinasi(destination: rekomedasi[index]),
                          ),
                        );
                      },
                      child: RekomendasiDestination(
                          destination: rekomedasi[index]),
                    ),
                  ),
                ),
              ),
